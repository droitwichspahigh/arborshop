...
class MultipleTablesConfig2 extends Common
{
	protected $Editor;
	protected $instanceName = 'mate2_';
	...
	protected function initiateEditor()
	{
		...
		$tableColumns['hire_date'] = array(
			...
			'null_array' => array('', '0000-00-00 00:00:00'),
		);
		...
		$this->Editor->setConfig('inputIdPrefix',$this->instanceName);
		//$this->Editor->setConfig('displayNum',5);
	...
	public function getDeptSuggestions()
	{
		...
		$queryParams['dept_var'] = $_POST['dept'].'%';
		$result = DBC::get()->query($query,$queryParams);
...
$page = new MultipleTablesConfig2();
?>
